...
public class InventoryRepository {
	...
	public void readProducts(){
		...
		inventory.setAllProducts(listP);
	}
	...
	public void addPart(Part part){
		String msg = Part.isValidPart(part.getName(),part.getPrice(),part.getUnitsStock(),part.getMinUnits(),part.getMaxUnits(),"");
		if(!msg.equals("")){

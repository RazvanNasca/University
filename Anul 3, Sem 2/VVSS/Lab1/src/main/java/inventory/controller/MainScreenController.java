...
public class MainScreenController implements Initializable,Controller {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        partsIdCol.setCellValueFactory(new PropertyValueFactory<Part, Integer>("partId"));
        partsNameCol.setCellValueFactory(new PropertyValueFactory<Part, String>("name"));
        partsInventoryCol.setCellValueFactory(new PropertyValueFactory<Part, Integer>("inStock"));
        partsPriceCol.setCellValueFactory(new PropertyValueFactory<Part, Double>("price"));

        // Populate products table view
        productsIdCol.setCellValueFactory(new PropertyValueFactory<Product, Integer>("productId"));
        productsNameCol.setCellValueFactory(new PropertyValueFactory<Product, String>("name"));
        productsInventoryCol.setCellValueFactory(new PropertyValueFactory<Product, Integer>("inStock"));
        productsPriceCol.setCellValueFactory(new PropertyValueFactory<Product, Double>("price"));
    }

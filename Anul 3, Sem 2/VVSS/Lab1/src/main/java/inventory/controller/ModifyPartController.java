...
public class ModifyPartController implements Initializable, Controller {
    ...
    private void fillWithData(){
        ...
        inventoryTxt.setText(Integer.toString(part.getUnitsStock()));
        priceTxt.setText(Double.toString(part.getPrice()));
        maxTxt.setText(Integer.toString(part.getMaxUnits()));
        minTxt.setText(Integer.toString(part.getMinUnits()));

...
public class HomeController extends UnicastRemoteObject implements Initializable, IFestivalObserver {
    ...
    public HomeController(IFestivalServices serviceFestival) throws RemoteException {

...
public class ModifyProductController implements Initializable, Controller {
    ...
    private void fillWithData(){
        ...
        addProductIdCol.setCellValueFactory(new PropertyValueFactory<Part, Integer>("partId"));
        addProductNameCol.setCellValueFactory(new PropertyValueFactory<Part, String>("name"));
        addProductInventoryCol.setCellValueFactory(new PropertyValueFactory<Part, Integer>("inStock"));
        addProductPriceCol.setCellValueFactory(new PropertyValueFactory<Part, Double>("price"));
        ...
        inventoryTxt.setText(Integer.toString(product.getUnitsStock()));
        priceTxt.setText(Double.toString(product.getPrice()));
        maxTxt.setText(Integer.toString(product.getMaxUnits()));
        minTxt.setText(Integer.toString(product.getMinUnits()));
    ...
    public void updateDeleteProductTableView() {
        ...
        deleteProductIdCol.setCellValueFactory(new PropertyValueFactory<Part, Integer>("partId"));
        deleteProductNameCol.setCellValueFactory(new PropertyValueFactory<Part, String>("name"));
        deleteProductInventoryCol.setCellValueFactory(new PropertyValueFactory<Part, Integer>("inStock"));
        deleteProductPriceCol.setCellValueFactory(new PropertyValueFactory<Part, Double>("price"));
    }

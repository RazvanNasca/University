...
public class AddProductController implements Initializable, Controller {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        addProductInventoryCol.setCellValueFactory(new PropertyValueFactory<Part, Double>("inStock"));
    ...
    public void updateDeleteProductTableView() {
        ...
        deleteProductInventoryCol.setCellValueFactory(new PropertyValueFactory<Part, Double>("inStock"));
        deleteProductPriceCol.setCellValueFactory(new PropertyValueFactory<Part, Integer>("price"));
    }
